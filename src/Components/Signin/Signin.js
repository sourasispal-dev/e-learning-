...
function Signin() {
  ...
  <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
    <h2 class="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-8 lg:text-3xl">Sign in your Account</h2>
    ...
    <form class="mx-auto max-w-lg rounded-lg border">
      <div class="flex flex-col gap-4 p-4 md:p-8">
        ...
        <div class="relative flex items-center justify-center">
          ...
          <span class="relative bg-white px-4 text-sm text-gray-400">Sign in with social</span>
        </div>
      ...
      <div class="flex items-center justify-center bg-gray-100 p-4">
        <p class="text-center text-sm text-gray-500">Don't have an account? <a href="/Register" class="text-indigo-500 transition duration-100 hover:text-indigo-600 active:text-indigo-700">Register</a></p>
      </div>
    </form>
  </div>
</div>
